...
let questions = [
    ...
    },
    {
        ...
        {
            answer: '"There\'s a simple way to boost the marriage rate, " says gay rights activist @@RANDOMNAME@@. "Abolish those archaic laws that discriminate against same-sex marriages.It\'s obscene to treat people differently because of their sexual preference. Besides, everyone knows gay relationships are more stable than straight ones."',
            effects: (nation) => {
                nation.personalFreedom += 0.8;
            }
        }] 
